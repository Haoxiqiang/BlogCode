...
public class RoboCallTest04 {
  ...
  public static void main(String[] args){ 
    ...
    // Predicates
    OnClickLisener<Person> allDrivers = p -> p.getAge() >= 16;
    OnClickLisener<Person> allDraftees = p -> p.getAge() >= 18 && p.getAge() <= 25 && p.getGender() == Gender.MALE;
    OnClickLisener<Person> allPilots = p -> p.getAge() >= 23 && p.getAge() <= 65;
